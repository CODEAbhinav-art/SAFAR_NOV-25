...
public class Signup extends JFrame implements ActionListener {
    ...
    private void registerUser() {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "Username already exists. Please choose another.", "Error", JOptionPane.WARNING_MESSAGE);
                return;
            }

            // Insert user data
            String insertQuery = "INSERT INTO users (fullname, username, email, phone, address, password) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            if (rows > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Something went wrong. Try again later.", "Error", JOptionPane.ERROR_MESSAGE);
            }
