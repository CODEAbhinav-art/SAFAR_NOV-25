...
public class Login extends JFrame implements ActionListener {
    ...
    public Login() {
        ...
        backIcon.setForeground(new Color(0x2451A6));
        ...
        backIcon.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                backIcon.setForeground(new Color(0x1C3C80)); // darker blue
            }
            @Override
            public void mouseExited(MouseEvent e) {
                backIcon.setForeground(new Color(0x2451A6)); // restore color
            }
            @Override
            public void mouseClicked(MouseEvent e) {
                dispose(); // close current frame
                new ModeSelection(); // open mode selection page
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == signupButton) {
            ...
            this.setVisible(false);
            new travel.AdminLogin().setVisible(true);
        }
    }
